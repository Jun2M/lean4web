...
The project can be accessed via http://localhost:3000. (Internally, WebSocket requests to `ws://localhost:3000/websocket/<project>` will be forwarded to a Lean server running on port 8080.)
